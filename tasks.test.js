...
describe('String functions', () => {
    ...
    test('Get a reverse string', () =>{
        // Assert
        expect(reverseString("joseph")).toMatch(/hpesoj/);
    });

    test('capitalize should return first character capitalized', () =>{
        // Assert
        expect(capitalize("joseph")).toMatch(/Joseph/);
    })

    test('capitalize should receive a string', () =>{
        // Assert
        expect(capitalize(word)).toBeTruthy();
    })
})
...
describe('Calculator functions', () => {
    ...
    describe('multiply function', () =>{
        test('multiply 100 * 5 to equal 500', () =>{
            // Assert
